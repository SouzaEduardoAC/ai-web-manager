...
<template>
  <div class="flex-1 overflow-y-auto">
    <div class="mb-6 flex justify-between items-end">
      ...
      <button @click="showAddMcpModal = true" class="bg-mcp-blue hover:bg-blue-400 text-mcp-dark px-6 py-2 rounded-lg font-black text-xs uppercase tracking-widest shadow-lg shadow-mcp-blue/20 transition-all active:scale-95">
        + Register Server
      </button>
    </div>
    ...
    <div v-if="showAddMcpModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div class="absolute inset-0 bg-mcp-dark/80 backdrop-blur-sm" @click="showAddMcpModal = false"></div>
